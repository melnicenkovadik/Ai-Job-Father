// icons.jsx — shared glyph components (stroke-based, scale via color)
...
const Icon = {
  ...
  Check: ({ size = 16, stroke = 'currentColor', w = 2 }) => (
  ...
  Plus: ({ size = 16, stroke = 'currentColor', w = 2 }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={stroke} strokeWidth={w} strokeLinecap="round">
      <path d="M12 5v14M5 12h14"/>
    </svg>
  ),
  Close: ({ size = 16, stroke = 'currentColor' }) => (
  ...
  Doc: ({ size = 16, stroke = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={stroke} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/>
      <path d="M14 2v6h6M9 13h6M9 17h6"/>
    </svg>
  ),
  Spark: ({ size = 16, fill = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={fill}>
  ...
  Clock: ({ size = 16, stroke = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={stroke} strokeWidth="2" strokeLinecap="round">
  ...
  Alert: ({ size = 16, stroke = 'currentColor' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={stroke} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2L2 20h20L12 2z"/><path d="M12 10v5M12 18h.01"/>
    </svg>
  ),
  Wifi: ({ size = 14, fill = 'currentColor' }) => (
    <svg width={size} height={size * 0.7} viewBox="0 0 16 11" fill={fill}>
